-- ============================================================================
-- Migration: Ultra-Safe Market Updater (No SELECT INTO)
-- ============================================================================
-- Description: Completely avoids SELECT INTO to prevent "more than one row" errors
-- Date: 2026-03-04
-- ============================================================================
...
BEGIN
  ...
  -- Get current market data using individual queries (no SELECT INTO)
  SELECT market_probability INTO v_current_probability FROM markets WHERE id = p_market_id LIMIT 1;
  SELECT volume_24h INTO v_current_volume_24h FROM markets WHERE id = p_market_id LIMIT 1;
  SELECT liquidity INTO v_current_liquidity FROM markets WHERE id = p_market_id LIMIT 1;
  SELECT status INTO v_current_status FROM markets WHERE id = p_market_id LIMIT 1;
